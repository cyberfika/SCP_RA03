# -*- coding: utf-8 -*-
"""
Programa 2 - Cobertura de Combinacoes de 14 Elementos
Determina SB15,14 <= S15 tal que toda combinacao de 14 elementos
esteja contida em pelo menos um elemento de SB15,14.

  Para todo Y em S14, existe X em SB15,14 tal que Y <= X

Lower bound LP: |SB| >= C(25,14) / C(15,14) = 4.457.400 / 15 = 297.160
"""
